...
function init() {
    ...
    $('.frame-4 p').html('CAPITALISE ON<br>THE LEADING<br>FINANCE AND<br>BUSINESS NEWS');
...
function start() {
    ...
    function featureAnimation() {
        tlFeature.set('.feature', {x:0})
                 ...
                 .to('.feature', 1.5, {ease:Power1.easeInOut, y:102, autoAlpha:0, delay:4})
                 .to('#water', 1.5, {ease:Power1.easeInOut, y:"+=244"}, "-=1.5")
